...
# Remove "USA: " and "USA:" from values in the location column to get a state column.
...
# Join 2021 statewide case counts with center coordinates to use as state labels:
